...
async function createSummoner(chatid){
    ...
    db.updateSummoner(chatid, 'summonerId', summonerId)
    db.updateSummoner(chatid, 'accountId', accountId)
    db.updateSummoner(chatid, 'puuid', puuid)
    db.updateSummoner(chatid, 'nickname', summonerName)
    db.updateSummoner(chatid, 'profileIconId', profileIconId)
    db.updateSummoner(chatid, 'level', summonerLevel)
